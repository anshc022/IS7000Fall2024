  ...
  return (
    <nav className='flex justify-between p-5 items-center border-b bg-[#e7e7e7d1] nav'>
      ...
      <ul className='hidden md:flex gap-6'>
        ...
        {isAuthenticated && isAdmin && (
          <>
            <Link to='/Subscriptionadminhome'><li>Subscription Admin Home</li></Link>
            <Link to='/batch'><li>Batch</li></Link>
            <Link to='/log'><li>Logs</li></Link>
          </>
        )}
        {isAuthenticated ? (
      ...
      >
        ...
        {isAuthenticated && isAdmin && (
          <>
            <Link to='/Subscriptionadminhome'><li className='hover:text-teal-700'>Subscription Admin Home</li></Link>
            <Link to='/batch'><li className='hover:text-teal-700'>Batch</li></Link>
            <Link to='/log'><li className='hover:text-teal-700'>Logs</li></Link>
          </>
        )}
        {isAuthenticated ? (
